...
/*   Updated: 2024/04/25 16:50:16 by mgagne           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		Bureaucrat::signForm(AForm &src)
{
	...
	{
		src.beSigned(*this);
		std::cout << name << " successfully signed form : " << src.getName() << std::endl;
	}
...
void    Bureaucrat::executeForm(const AForm &form)
{
	...
	{	std::cerr << name << " couldn't execute " << form.getName() << " because " << error.what(); }
}
